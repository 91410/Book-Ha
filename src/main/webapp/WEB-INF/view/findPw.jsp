            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Book_Ha</span>
                </a>
              </div>
              <!-- /Logo -->
              ...
              <!-- <form id="formAuthentication" class="mb-3" action="index.html" method="POST"> -->
                ...
                <div class="mb-3">
                  ...
                  <input type="text" id="option" class="form-control" name="option" placeholder="답을 입력해주세요" autofocus />
                </div>
